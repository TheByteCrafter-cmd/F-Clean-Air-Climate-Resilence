...
from backend.api.v1.endpoints.decision import router as decision_router
...
# Register Citizen Evidence, Evidence Fusion, Hotspot Detection, Forecasting, Risk, and Decision Sub-Routers
